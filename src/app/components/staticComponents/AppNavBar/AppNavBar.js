  ...
  return (
    <NavBar barColor="primary" sx={styles.navBar} styleOverride={{ minHeight: '4.5rem', justifyContent: 'center' }}>
      ...
      <Box sx={styles.iconsBox}>
        <IconButton aria-label="cart" sx={styles.navBarIconButton}>
          <ShoppingBagOutlinedIcon />
        </IconButton>
        <IconButton aria-label="profile" sx={styles.navBarIconButton}>
